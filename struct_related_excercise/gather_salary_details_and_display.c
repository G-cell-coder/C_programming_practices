...
int main() {
    ...
    // Find the employee with the highest salary
    struct Employee lowestSalaryEmployee;
    if (employee1.salary <= employee2.salary && employee1.salary <= employee3.salary) {
        lowestSalaryEmployee = employee1;
    } else if (employee2.salary <= employee1.salary && employee2.salary <= employee3.salary) {
        lowestSalaryEmployee = employee2;
    } else {
        lowestSalaryEmployee = employee3;
    }

    // Display information for the employee with the highest salary
    printf("\nEmployee with the lowest Salary:\n");
    printf("Employee ID: %d\n", lowestSalaryEmployee.employeeID);
    printf("Name: %s\n", lowestSalaryEmployee.name);
